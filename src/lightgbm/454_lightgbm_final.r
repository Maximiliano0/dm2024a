...
setwd("C:/Users/maxvega/Downloads/MCD/DataMining")

# cargo MI semilla, que esta en MI bucket
tabla_semillas <- fread( "C:/Users/maxvega/Downloads/MCD/DataMining/datasets/mis_semillas.txt")
ksemilla_azar <- tabla_semillas[ 1, 1 ]  # 1 es mi primer semilla
