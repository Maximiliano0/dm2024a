...
PARAM$semillas <- c(705011, 705013, 705017, 705031, 705043, 705053, 705073, 705079, 705097, 705113, 705119, 705127, 705137, 705161, 705163, 705167, 705169, 705181, 705191, 705197)
...
# la funcion mcmapply  llama a la función ArbolEstimarGanancia
